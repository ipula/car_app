...
class JobCardController extends Controller
{
    ...
    public function createJobCardByWeb(Request $request)
    {
        $success=false;
        $data=$request->all();
...
//                        $jobCardDetail->job_card_warranty_status = $data['addedDetail'][$x]['job_card_warranty_status'];
    ...
    {
        $jobCard=JobCard::with(['getVehicle.getBrand','getVehicle.getModel','getUser','getJobCardMaterial.getMaterial','getJobCardDetails.getService','getJobCardDetails.getServiceType','getJobCardDetails.getTechnician.techData'])->where('job_card_status','=',2)->orWhere('job_card_status', '=',3)->get();
